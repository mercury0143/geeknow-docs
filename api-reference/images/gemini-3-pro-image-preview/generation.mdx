...
```bash
curl -X POST https://apidoc.geeknow.top/v1beta/models/gemini-3-pro-image-preview:generateContent \
...
resp = requests.post(
    "https://apidoc.geeknow.top/v1beta/models/gemini-3-pro-image-preview:generateContent",
    headers={
