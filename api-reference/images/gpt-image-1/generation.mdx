...
<Info>
如果你实际使用的是 `gpt-image-2-pro`，插件侧还额外暴露了 `1:1(2K)`、`4:3(2K)`、`3:2(2K)`、`2:3(2K)`、`16:9(2K)`、`9:16(2K)`、`1:1(4K)`、`4:3(4K)`、`3:2(4K)`、`2:3(4K)`、`16:9(4K)`、`9:16(4K)` 这类高分档位。完整映射见 [图像模型支持矩阵](/api-reference/images/model-matrix)。
</Info>
