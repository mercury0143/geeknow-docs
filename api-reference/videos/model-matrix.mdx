...
| Grok Video 3 | `grok-video-3-pro`、`grok-video-3-max` | [Grok Video 3](/api-reference/videos/grok/grok-video-3) | `/v1/videos` | 文生视频、首帧生视频、首尾帧、参考生视频 | multipart `input_reference`，支持重复字段传多图 |
...
| 项目 | 说明 |
| --- | --- |
| 模型示例 | `grok-video-3-pro`、`grok-video-3-max` |
| 推荐入口 | `POST /v1/videos` |
