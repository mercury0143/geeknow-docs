...
| Seedance 2.0 | `seedance-2.0-lite`、`seedance-2.0-pro`、`seedance-2.0-fast` | [概览](/api-reference/videos/seedance-2/overview) | `/v1/videos` | 文生视频、首帧、尾帧、参考图、参考视频、参考音频 | JSON URL 字段 |
...
| `seedance-2.0-lite` | Seedance 2.0 | Seedance 2.0 lite 档位；支持 JSON URL 字段。 |
| `seedance-2.0-pro` | Seedance 2.0 | Seedance 2.0 pro 档位；支持首帧、尾帧、参考图、参考视频和参考音频。 |
| `seedance-2.0-fast` | Seedance 2.0 | Seedance 2.0 fast 档位；适合更快提交的视频任务。 |
