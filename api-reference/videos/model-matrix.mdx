...
| 豆包 Seedance | `doubao-seedance-1-5-pro_*` | 暂未单独展开 | `/v1/videos` | 文生视频、首帧生视频、首尾帧 | multipart `first_frame_image` / `last_frame_image` |
| 阿里 wan2.6 | `wan2.6-t2v:*`、`wan2.6-i2v:*` | 暂未单独展开 | `/v1/videos` | 文生视频、图生视频 | multipart `image` 或 `input_reference` |
| Vidu | `Vidu-q3-pro`、`Vidu-q3-turbo` | 暂未单独展开 | `/v1/videos` | 文生视频、首帧生视频、首尾帧、参考生视频 | JSON `image` / `images` / `metadata.last_frame_url` |
| Kling | `Kling-3.0`、`Kling-3.0-Omni` | 暂未单独展开 | `/v1/videos`、`/kling/v1/videos/*` | 文生视频、首帧生视频 | JSON `image` |
| Hailuo | `Hailuo-2.3`、`Hailuo-2.3-fast` | 暂未单独展开 | `/v1/videos` | 文生视频、首帧生视频 | JSON `image` |
...
| 参考图 | 当前主流程是 JSON `input_reference`，网关仍兼容 multipart |
| 宽高比 | 常见 `16:9`、`9:16` |
...
| 常见模式 | 文生视频、首尾帧、参考生视频 |
| 参考图 | 当前主流程是 JSON `input_reference`，下游再映射到 Veo 请求结构 |
