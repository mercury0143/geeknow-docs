...
2. [Veo 视频概览](/api-reference/videos/veo/overview)
3. 如果你要做图生视频，先确认目标模型需要的是 `image`、`images`、`input_reference` 还是 `first_frame_image` / `last_frame_image`。
4. 如果你明确是 Kling 官方格式接入，再看 `/kling/v1/videos/*` 这一组路由。
